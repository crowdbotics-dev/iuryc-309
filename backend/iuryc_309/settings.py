"""
Django settings for iuryc_309 project.
...
WSGI_APPLICATION = 'iuryc_309.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "iuryc_309 API",
    "DESCRIPTION": "API documentation for iuryc_309 App",
    "VERSION": "v1",
}
